...
class DefaultSyntaxHighlighter extends SyntaxHighlighter {
  /// Highlight language
  ///
  ...
  TextSpan format(String language, String src) {
    ...
    final String source = src..replaceAll('\t', ' ' * tabSize);

    return TextSpan(
      style: _textStyle,
      children: _convert(highlight
          .parse(source, language: language ?? this.defaultLanguage)
          .nodes),
    );
  }
}
